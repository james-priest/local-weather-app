...
// const TimeZoneAPIKey = "AIzaSyA3s1DvIhBdiU6BoUFqsTrs6WVdHKXCkZg";
const TimeZoneAPIKey = "AIzaSyC5V7xn0m45R2i8VdA82C6CNLmDvFWK7Yw";
...
function shoutOutToMyPeeps() {
  $("#btn-Nairobi").popup({
    ...
    content:
      "This is for my friend in Kenya who's gonna run her own game dev company one day!👍😁",
    variation: "wide",
  ...
  $("#btn-Cape-Cod").popup({
    ...
    content:
      "This is for my Twitter friend and fellow countryman on the East Coast who always has words of encouragement and support for his fellow coders.👏🙏🙆👌",
    variation: "wide",
    position: "left center",
    inline: "true",
  });
  ...
  $("#btn-Los-Angeles").popup({
    title: "🙋✌ My Hood. 😎😜",
    content:
      "This is for me so I can see what the ⛅weather's like before a run 🎽🏃or hike🎒👟.",
    variation: "wide",
    position: "left center",
    inline: "true",
  });
